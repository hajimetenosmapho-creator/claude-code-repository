"""
Workflow Engine Manager（v2.7.0、v2.8.0でExecution History連携を追加）
...
設計方針:
    ...
    - [v2.8.0] ExecutionHistoryConfig.from_env() から ExecutionHistoryManager を構築し、
...
from execution_history import ExecutionHistoryConfig, ExecutionHistoryManager
...
class WorkflowEngineManager:
    ...
    def from_config(
        ...
        history_manager = ExecutionHistoryManager.from_config(
