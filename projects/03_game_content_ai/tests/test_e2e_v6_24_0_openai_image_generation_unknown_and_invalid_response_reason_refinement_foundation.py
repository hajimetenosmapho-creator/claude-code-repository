...
try:
    ...
    _allowed_source_changes = _guard_registry.allowed_source_changes_for("v6.24.0")
    ...
    # 共有レジストリ（DEF-6.23-9）が本Release（v6.24.0）以降のwindowとして
    # 合成する集合の範囲内以外に差分があってはならない。
    _allowed_test_changes = set(_guard_registry.allowed_test_changes_for("v6.24.0"))
