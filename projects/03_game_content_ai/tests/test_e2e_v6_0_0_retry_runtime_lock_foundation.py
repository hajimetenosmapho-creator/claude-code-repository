...
# src/retry_composition・src/retry_runtime_orchestrator・src/retry_engine・
# src/retry_enqueue_triggerは承認済み変更対象ファイルを持つため、このリストからは
# 除外する（docs/design/retry_lineage_eligibility_durable_attempt_state.md 22章。
